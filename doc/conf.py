...
# -*- coding: utf-8 -*-
#
# AlQorithms documentation build configuration file, created by
# sphinx-quickstart on Fri Apr  6 09:18:03 2018.
#
...
versions = __version__.split(sep='.')
...
html_theme = "sphinx_rtd_theme_hqs"
...
texinfo_documents = [
    (master_doc, project, '{} Documentation'.format(project),
     author, project, 'A Python library to access QAD Cloud.',
     'Miscellaneous'),
]
