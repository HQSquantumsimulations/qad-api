...
from qad_api.core.internal.util.serialization import *
from requests.exceptions import HTTPError
from typing import Union, cast


"""A dummy type for using a symbolic value of 'self' in function argument default values (instead of self)."""
Symbolic_self = str
...
class Module:
    ...
    def _request(self, method: str, subpath: str, data: any, target_class: any, target_module: Module = None, target_object = None):
        """
